...
const SellingProductsNew = () => {
    ...
    return (
        <div className='relative'>
            <h2 className='text-3xl capitalize text-center font-semibold mb-4 mt-10'>best Selling products</h2>

            <div ref={slideRef} className='px-8 flex max-w-screen-xl mx-auto overflow-scroll scroll-smooth scrollbar-hide rounded-xl'>
                                ...
                                <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
                                    <div className="flex flex-grow gap-2 items-center">
                                        <div className="flex flex-col">
                                            <h4 className="text-tiny text-white/60 capitalize font-bold">{product.title}</h4>
                                            <p className="text-white/90 font-medium text-xl capitalize">{product.desc}</p>
                                        </div>
                                    </div>
                                    <Button radius="full" color='primary' size="sm">{product.price}</Button>
                                </CardFooter>
                            </Card>
                        </div>
                    ))}
